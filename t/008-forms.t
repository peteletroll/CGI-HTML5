...
is_deeply($Q->elt(\"input", { name => "a" }, $Q->default("default")),
...
$Q->reset_form();
is_deeply($Q->elt(\"textarea", { name => "a" }, $Q->default("default")),
...
$Q->reset_form();
is_deeply($Q->elt(\"input", { name => "a", type => "checkbox", value => "a1" }, $Q->default("a1")),
	"<input checked name=\"a\" type=\"checkbox\" value=\"a1\">");
is_deeply($Q->elt(\"input", { name => "a", type => "checkbox", value => "a1" }, $Q->default("a1")),
	"<input name=\"a\" type=\"checkbox\" value=\"a1\">");
is_deeply($Q->elt(\"input", { name => "a", type => "checkbox", value => "a2" }, $Q->default("a1")),
	"<input checked name=\"a\" type=\"checkbox\" value=\"a2\">");
is_deeply($Q->elt(\"input", { name => "a", type => "checkbox", value => "a2" }, $Q->default("a1")),
	"<input name=\"a\" type=\"checkbox\" value=\"a2\">");

$Q->reset_form();
is_deeply($Q->elt(\"input", { name => "c", type => "checkbox", value => "c1" }, $Q->default("c1")),
	"<input checked name=\"c\" type=\"checkbox\" value=\"c1\">");
is_deeply($Q->elt(\"input", { name => "c", type => "checkbox", value => "c2" }, $Q->default("c1")),
